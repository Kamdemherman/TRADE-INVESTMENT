            ...
            <div class=" form">
              <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="{{route('administration.slider.edit',$slider->id)}}" enctype="multipart/form-data">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <input class=" form-control" id="lien1" name="lien1" minlength="2" type="text" value="{{$slider->lien1}}" />
                  </div>
                </div>
                <div class="form-group ">
                  <label for="lien" class="control-label col-lg-2">Bouton </label>
                  <div class="col-lg-10">
                    <input class=" form-control" id="lien2" name="lien2" minlength="2" type="text" value="{{$slider->lien2}}" />
                  </div>
                </div>
                <div class="form-group ">
