          ...
          <div class="form-panel">
            <div class=" form">
              <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="{{route('administration.slider')}}" enctype="multipart/form-data">
                ...
                <div class="form-group ">
                  <label for="lien" class="control-label col-lg-2">Bouton 1</label>
                  <div class="col-lg-10">
                    <input class=" form-control" id="lien1" name="lien1" minlength="2" type="text"  />
                  </div>
                </div>
                <div class="form-group ">
                  <label for="lien" class="control-label col-lg-2">Bouton 2</label>
                  <div class="col-lg-10">
                    <input class=" form-control" id="lien2" name="lien2" minlength="2" type="text"  />
                  </div>
                </div>
                <div class="form-group ">
