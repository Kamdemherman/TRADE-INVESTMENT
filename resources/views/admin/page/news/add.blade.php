  ...
  <section class="wrapper">
    ...
    <div class="row mt">
        <div class="col-lg-12">
          ...
          <div class="row">
            <div class="col-md-4 col-sm-4 mb"><a style="float: left;margin-left: 100px" href="/administration/news" type="button"  class="btn btn-default"><i class="fa fa-arrow-circle-o-left" style="color: #08367A" aria-hidden="true"></i> Retourner à la liste</a></div>
         ...
         @include('admin.page.message');
          <div class="form-panel">
            <div class=" form">
              <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="{{route('administration.news')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <input class=" form-control" id="auteur" name="auteur" minlength="2" type="text" required />
                  </div>
                </div>
                <div class="form-group ">
