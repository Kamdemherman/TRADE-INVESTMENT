...
<div class="flex flex-col h-screen w-screen bg-white mt-100" >
  ...
  <div class="flex flex-row  items-center  bottom-0 my-2 w-full" >
    ...
    <div class="ml-3 mr-2">
        <input type="text"id="pseudo" class="border rounded-2xl border-transparent  items-center" placeholder="Votre peudo"
      />
