...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="/administration/home" class="logo"><b style="color:#08367A">Tra<span style="color:#F39200">de</span></b></a>
      <!--logo end-->
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="/administration/about">Notre mission</a></li>
              <li><a href="/administration/vision">Notre vision</a></li>
              <li><a href="/administration/valeur">Nos valeurs</a></li>
              <li><a href="/administration/histoire">Histoire</a></li>
              <li><a href="/administration/strategie">Notre stratégie</a></li>
              
            </ul>
          </li>
          <li>
            <a href="/administration/contenu">
          ...
          <li>
            <a href="/administration/mot-directeur">
          ...
          <li>
            <a href="/administration/activite">
          ...
          <li>
            <a href="/administration/reference">
              
              <i class="fa fa-cogs"></i>
              <span>Nos référence  </span>
              <span class="label label-theme pull-right mail-info"></span>
              </a>
          </li>
          <li>
            <a href="/administration/documentation">
          ...
          <li>
            <a href="/administration/recompense">
          ...
          <li>
            <a href="/administration/gallerie">
              <i class="fa fa-image"></i>
              <span>Gallerie </span>
              <span class="label label-theme pull-right mail-info"></span>
              </a>
